  ...
  return (
    <section id='services' className='relative py-20 bg-black overflow-hidden'>
      <div className='absolute inset-0 overflow-hidden '>
        <div className='absolute top-1/4 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl ' /> 
        <div className='absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl ' /> 
        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary/10 rounded-full blur-3xl opacity-25  ' /> 
      </div>
{/* bg-line code ha ye */}
      <div 
      ...
      <Fadein delay={0}>
        <div className='text-center mb-16'>
          <div className=' inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full hover:border-primary/50'>
          ...
          <p className='text-lg text-white/60 max-w-xl mx-auto'>
            Comprehseive solutions to transform your idea into reality
          </p>
        </div>
      </Fadein>
        ...
        {services.slice(0,2).map((service, index) =>{
          ...
          return(
            <Fadein key={service.id} delay={100 + index * 100} >
              <div className='group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full max-h-[280px] flex flex-col '>
                <div className='mb-6'>
