...
import { PERSONAL_INFO, SOCIAL_LINKS, NAV_LINKS } from '../../utilis/constants'
    ...
    <footer className='relative bg-black overflow-hidden border-t border-white/10 '>
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 py-16 '>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-2 mb-12'>
                <Fadein delay={0}>
                    <div className=''>
                        <h3 className='text-3xl font-bold tracking-wide bg-linear-to-r from-primary/80 via-primary to-primary/80 bg-clip-text text-transparent mb-5'>
                ...
                <Fadein delay={200}>
                    <div>
                        ...
                        <p className='text-white/60 text-sm mb-6 leading-relaxed'>
                            Let's connecg and create something amazing toward
                        </p>
                            ...
                            {Object.entries(SOCIAL_LINKS).map(([platform, url])=>{
                                ...
                                return Icon ? (
                                    ...
                                    >
                                        ...
                                        <div className='absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/5 group-hover:to-primary/5 rounded-xl transition-all duration-300 pointer-events-none ' />
                                    </a>
                                ) : null
                            })}
                        </div>
