...
import { PERSONAL_INFO, SOCIAL_LINKS } from '../../utilis/constants'
                    ...
                    <Fadein delay={100}>
                        <div className='bg-white/5  border border-white/10 rounded-2xl p-8'>
                            <form onSubmit={handleSubmit} className='space-y-6'>
                                ...
                                <button type='submit'
                                    className='w-full px-6 py-3 bg-linear-to-r from-primary/10 to-primary text-white font-medium rounded-xl hover:shadow-2xl hover:shadow-primary/30 transition-all duration-300 flex justify-center gap-2 group: '
                                >
                        ...
                        <div className='space-y-8'>
                            <div>
                                ...
                                <p className='text-white/60 leading-relaxed'>
                                    I always open to discusing new project, creative ideas, or opportunites to be part of vision. feel free to reach out!
                                </p>
                            </div>
                                ...
                                <div className='group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 '>
                                    <div className='flex items-start gap-4'>
                                        ...
                                        <div className='flex-1'>
                                            <p className='text-white hover:text-[#A8FF8D] transition-colors font-medium'>Email</p>
                                            <a 
                                            href={`mailto: ${PERSONAL_INFO.email}`}className='' >{PERSONAL_INFO.email}</a>
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className='flex gap-4'>{Object.entries(SOCIAL_LINKS).slice(0,3).map(([platform, url])=>{
