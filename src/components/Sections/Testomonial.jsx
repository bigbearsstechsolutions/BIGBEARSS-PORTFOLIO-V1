...
const Testomonial = () => {
    ...
    const nextTestomonial =()=> {
        const newIndex = (currentIndex + 1) % testimonials.length;
        scrollToIndex(newIndex)
    };

    const prevTestomonial = ()=>{
            ...
            <Fadein delay={0}>
                <div className='text-center mb-16'>
                    <div className='inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-5'>
                        ...
                        <span className='text-sm text-primary font-medium tracking-wider uppercase'>Testomonials</span>
                    </div>
                                ...
                                >
                                    <div className='max-w-4xl mx-auto'>
                                        <div className='flex flex-col md:flex-row gap-6 items-stretch'>
                                            {/* Image section & img black and colr karne k code ha */}
