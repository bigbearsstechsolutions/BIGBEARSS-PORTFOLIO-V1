                        ...
                        <div className='flex flex-col gap-8'>
                            <Fadein delay={60}>
                                <div className='inline-flex items-center gap-2.5 px-5 py-2.5 border border-primary/30 bg-primary/10 rounded-full w-fit '>
                                    ...
                                    <span className='text-sm text-primary font-medium'>Full Stack Devloper</span>
                            ...
                            <Fadein delay={100}>
                                <h2 className='text-4xl lg:text-5xl font-normal text-white leading-tight'>
                                    Crafting Digital Expreience That Master.
                                </h2>
                            </Fadein>
                    ...
                    <Fadein delay={200}>
                        <div className='grid grid-cols-2 gap-4'>
                                ...
                                <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                                    <div className='flex items-start gap-4'>
                                        ...
                                        <div className='flex-1'>
                                            <h3 className='text-lg font-semibold text-white mb-2'>Expertized</h3>
                                            <p className='text-sm text-white/70 leading-relaxed'>
                                                Specialaized in building scalable web application with moder technologies and best practise.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='relative group'>
                                <div className='absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300'></div>
                                <div className='realtive bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/50 transition-opacity duration-300 h-full'>
                                    <div className='p-3 bg-primary/10 rounded-xl w-fit mb-4'>
                                        <Sparkles className='w-5 h-5 text-primary' />
                                    </div>
                                    <h3 className='text-base font-semibold text-white mb-2'>Clean Code</h3>
                                    <p className='text-sm text-white/70 leading-relaxed'>Writing maintainable, well-document code those are scale.</p>
                                </div>
                            </div>
                            <div className='relative group'>
                                <div className='absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300'></div>
                                <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                    ...
                                    <h3 className='text-base font-semibold text-white mb-2'>Perfomance</h3>
                                ...
                                <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                                    <div className='grid grid-cols-3 '>
                                        ...
                                        <div>
                                            ...
                                            <div className='text-xs text-white/60'>Support Availabel</div>
                                        </div>
                                        <div>
                    ...
                    <div className='flex flex-col items-center gap-8'>
                        <div className='text-center'>
                            ...
                            <p className='text-sm text-white/60'>
                                Technoligies I work with to build amazing products
                            </p>
                        </div>
                        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl' >
                            {skills.map((skill, index)=> (
                                <div key={index} className='group relative bg-white/5 hover:bg-white/10 border border-white/10 hover:border-primary/50 rounded-2xl
                                p-6 flex flex-col items-center justify-center gap-3 transition-all duration-300 hover:scale-105'>
